...
- Owner has no physical access to the Windows inference host for ~7 days (only real blocker)
- Model pair selection (leaning Qwen2.5-Coder 14B + Qwen2.5 14B) is a strong candidate but not locked — logged as a decision at T1.5, not before
